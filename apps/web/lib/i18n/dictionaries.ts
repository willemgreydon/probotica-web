...
const en = {
  ...
  pages: {
    ...
    solutionsTitle: 'AI solution stack',
    solutionsLead: 'Choose assistants, prompt products, and automation systems built for measurable business outcomes. Every module is production-safe and cross-linked.',
    industriesEyebrow: 'Industries',
    industriesTitle: 'Industry playbooks',
    industriesLead: 'Applied AI operating models for real estate, marketing, education, and operations teams. Domain-tuned bots, workflows, and industry kits built for fast deployment.',
    studioEyebrow: 'AI Studio',
    studioTitle: 'Agent Studio',
    studioLead: 'Design, deploy, and monitor production-ready AI agent systems. Start with a live bot test, chain into a workflow, save outputs to workspace.',
    shopEyebrow: 'Shop',
    shopTitle: 'Prompt & agent marketplace',
    shopLead: 'Browse ready-to-launch prompt packs, AI workflow systems, and industry kits. Everything in ProBotica is production-safe and business-ready.',
  },
  product: {
...
const de: Dict = {
  ...
  pages: {
    ...
    solutionsTitle: 'KI-Lösungs-Stack',
    solutionsLead: 'Wähle Assistenten, Prompt-Produkte und Automatisierungssysteme für messbare Geschäftsergebnisse. Jedes Modul ist produktionssicher und vernetzt.',
    industriesEyebrow: 'Branchen',
    industriesTitle: 'Branchen-Playbooks',
    industriesLead: 'Angewandte KI-Betriebsmodelle für Immobilien, Marketing, Bildung und Operations-Teams. Domänenspezifische Bots, Workflows und Branchen-Kits für schnelles Deployment.',
    studioEyebrow: 'AI Studio',
    studioTitle: 'Agent Studio',
    studioLead: 'Entwirf, deploye und überwache produktionsreife KI-Agentensysteme. Starte mit einem Live-Bot-Test, verkette zu einem Workflow, speichere Ausgaben im Workspace.',
    shopEyebrow: 'Shop',
    shopTitle: 'Prompt- & Agent-Marktplatz',
    shopLead: 'Durchstöbere startklare Prompt-Pakete, KI-Workflow-Systeme und Branchen-Kits. Alles in ProBotica ist produktionssicher und geschäftsbereit.',
  },
  product: {
    botLabEyebrow: 'Bot Lab',
