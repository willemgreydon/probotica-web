...
const en = {
  ...
  product: {
    botLabEyebrow: 'Bot Lab',
    botLabTitle: 'Test imported assistants and workflow bots in a command-center sandbox.',
    botLabLead: 'Validate prompts, compare outputs, and prototype automation behavior before deployment.',
    botsAvailable: 'bots available',
    safety: 'Safety & Compliance',
    botRegistry: 'Bot Registry',
    searchBots: 'Search bots, tags, capabilities…',
    console: 'Console',
    compare: 'Compare',
    history: 'History',
    workspaceEyebrow: 'AI Workspace',
    workspaceIntro: 'Persistent local-first orchestration workspace with runtime history and memory snapshots.',
    ...
    workspacesIntro: 'Create, open, rename or delete your AI orchestration workspaces.',
    newWorkspaceShort: 'New workspace',
    open: 'Open',
    rename: 'Rename',
    delete: 'Delete',
...
const de: Dict = {
  ...
  product: {
    botLabEyebrow: 'Bot Lab',
    botLabTitle: 'Teste importierte Assistenten und Workflow-Bots in einer Command-Center-Sandbox.',
    botLabLead: 'Prüfe Prompts, vergleiche Ausgaben und prototypisiere Automatisierungsverhalten vor dem Deployment.',
    botsAvailable: 'Bots verfügbar',
    safety: 'Sicherheit & Compliance',
    botRegistry: 'Bot-Registry',
    searchBots: 'Bots, Tags, Fähigkeiten suchen…',
    console: 'Konsole',
    compare: 'Vergleich',
    history: 'Verlauf',
    workspaceEyebrow: 'KI-Workspace',
    workspaceIntro: 'Persistenter, local-first Orchestrierungs-Workspace mit Laufzeitverlauf und Memory-Snapshots.',
    newWorkspace: 'Neuer Workspace',
    allWorkspaces: 'Alle Workspaces',
    workspaceRegistry: 'Workspace-Registry',
    operationalNotes: 'Betriebsnotizen',
    memoryLayer: 'Memory-Layer',
    saveNote: 'Notiz speichern',
    deleteCurrent: 'Aktuellen löschen',
    workspacesTitle: 'Deine Workspaces',
    workspacesIntro: 'Erstelle, öffne, benenne um oder lösche deine KI-Orchestrierungs-Workspaces.',
    newWorkspaceShort: 'Neuer Workspace',
    open: 'Öffnen',
    rename: 'Umbenennen',
    delete: 'Löschen',
